...
if(NOT _exported_interfaces STREQUAL "")
  foreach(_interface ${_exported_interfaces})
    ...
    list(APPEND sparse_bundle_adjustment_INTERFACES ${_targets})
  endforeach()
endif()
